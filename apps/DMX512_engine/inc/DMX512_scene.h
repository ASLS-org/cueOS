...
typedef struct{
	...
	uint16_t fixture_preset_count;							/**< Count of current fixture presets associated to the scene*/
	DMX512_fixture_preset_s *fixture_presets;				/**< List of current fixture presets associated to the scene*/
