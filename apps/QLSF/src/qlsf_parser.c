...
static DMX512_engine_err_e _DMX512_qlsf_parser_load_scenes(DMX512_qlsf_s *qlsf){
	...
	for(uint16_t i=0; i<qlsf->header.scene_count; i++){
		...
		DMX512_scene_s scene  = DMX512_scene_init(scene_id, 5000, 500);
