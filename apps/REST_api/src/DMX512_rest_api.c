 ...
 */
static void DMX512_rest_api_get_fixtures(http_request_s *req){
 ...
 * 		parsing and retrieval.
 */
static void DMX512_rest_api_add_fixture(http_request_s *req){
...
void DMX512_rest_api_router(http_request_s *req){
	...
	switch(endpoint){
		case DMX512_API_ENDPOINT_PATCH:
			switch(req->method){
				case HTTP_GET: 	DMX512_rest_api_get_fixtures(req); 	break;
				case HTTP_POST: DMX512_rest_api_add_fixture(req);	break;
				default:										break;
			}
			break;
		default:
