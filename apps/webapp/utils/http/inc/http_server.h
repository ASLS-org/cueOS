/**
 * @defgroup webapp
 * Definition of a suite of WEB services enabling remote device
 * configuration through the use of HTTP services.
 * @{
 *
 * @defgroup webapp_utils
 * Tools and helpers to be used by the webapp module
 * @{
 *
 * @defgroup HTTP
 * Handles HTTP packet transactions
 * @{
 *
